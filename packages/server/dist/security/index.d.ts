...
export declare function corsMiddleware(): (req: Request, res: Response, next: NextFunction) => Response<any, Record<string, any>>;
...
export declare function rateLimitMiddleware(limit?: number, windowSeconds?: number): (req: Request, res: Response, next: NextFunction) => Promise<Response<any, Record<string, any>>>;
export declare function verifyHMAC(payload: string | Buffer, signature: string, secret: string): boolean;
export declare function bodySizeLimitMiddleware(): (req: Request, res: Response, next: NextFunction) => Response<any, Record<string, any>>;
